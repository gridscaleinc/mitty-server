...
type Island struct {
	...
	GeohashLevel8  int64     `db:"geohash_l8" json:"geohash_l8"`
	GeohashLevel10 int64     `db:"geohash_l10" json:"geohash_l10"`
	GeohashLevel12 int64     `db:"geohash_l12" json:"geohash_l12"`
